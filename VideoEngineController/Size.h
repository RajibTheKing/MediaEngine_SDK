...
//#define USE_FIXED_BITRATE_PER_SLOT

#ifdef USE_FIXED_BITRATE_PER_SLOT
    #define FRAME_RATE 15
    #define MAX_FRAME_RATE 15
    #define I_INTRA_PERIOD 8
    #define FIXED_BITRATE_TOLERANCE 1.2
    #define BITRATE_DECREMENT_FACTOR (0.7/FIXED_BITRATE_TOLERANCE)
    #define NORMAL_BITRATE_RATIO_IN_MEGA_SLOT 95
    #define GOOD_BITRATE_RATIO_IN_MEGA_SLOT 98
    #define GOOD_MEGASLOT_TO_UP 5
    #define BITRATE_INCREAMENT_FACTOR 1.05
    #define BITRATE_MAX (500000 * (FRAME_RATE / MAX_FRAME_RATE) /FIXED_BITRATE_TOLERANCE)
    #define BITRATE_MIN (100000 * (FRAME_RATE / MAX_FRAME_RATE) /FIXED_BITRATE_TOLERANCE)
    #define MAX_BITRATE_TOLERANCE 0
    #define MAX_BITRATE_MULTIPLICATION_FACTOR 1
#else
    #define FRAME_RATE 15
    #define I_INTRA_PERIOD 8
...
#define NUMBER_OF_WAIT_SLOT_TO_DETECT_UP_FAIL 300
