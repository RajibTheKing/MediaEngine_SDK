...
#define MAX_VIDEO_DECODER_FRAME_SIZE WIDTH * HEIGHT * 3

#if defined SOUL_SELF_DEVICE_CHECK

#define MAX_VIDEO_ENCODER_BUFFER_SIZE 150
...
#define MAX_VIDEO_RENDERER_FRAME_SIZE WIDTH * HEIGHT * 3
...
#define FPS_TOLERANCE_FOR_HIGH_RESOLUTION 1
#define FPS_TOLERANCE_FOR_FPS 1
