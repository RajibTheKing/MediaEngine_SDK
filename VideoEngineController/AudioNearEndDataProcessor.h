...
namespace MediaSDK
{
	...
	protected:
		...
		void BuildAndGetHeaderInArray(int packetType, int nHeaderLength, int networkType, int packetNumber, int packetLength, int channel, int version, long long timestamp, unsigned char* header);
