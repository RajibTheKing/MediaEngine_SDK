...
{
	CLogPrinter_WriteLog(CLogPrinter::INFO, THREAD_LOG, "CVideoEncodingThreadOfLive::StopEncodingThread called");
	...
	CLogPrinter_WriteLog(CLogPrinter::INFO, THREAD_LOG, "CVideoEncodingThreadOfLive::StopEncodingThread Encoding Thread STOPPED");
}
...
void *CVideoEncodingThreadOfLive::CreateVideoEncodingThread(void* param)
{
	CVideoEncodingThreadOfLive *pThis = (CVideoEncodingThreadOfLive*)param;
	pThis->EncodingThreadProcedure();

	return NULL;
}

void CVideoEncodingThreadOfLive::ResetForViewerCallerCallEnd()
{
...
void CVideoEncodingThreadOfLive::ResetForPublisherCallerInAudioOnly()
{
...
void CVideoEncodingThreadOfLive::SetOrientationType(int nOrientationType)
{
	m_nOrientationType = nOrientationType;
}

bool CVideoEncodingThreadOfLive::IsThreadStarted()
{
	return m_bIsThisThreadStarted;
}

void CVideoEncodingThreadOfLive::SetNotifierFlag(bool flag)
{
...
void CVideoEncodingThreadOfLive::EncodingThreadProcedure()
{
	...
	{
		//CLogPrinter_WriteLog(CLogPrinter::INFO, THREAD_LOG ,"CVideoEncodingThreadOfLive::EncodingThreadProcedure() RUNNING EncodingThreadProcedure method");
...
//			CLogPrinter_WriteLog(CLogPrinter::INFO, INSTENT_TEST_LOG ," Client FPS: " + Tools::DoubleToString(m_pVideoCallSession->GetFPSController()->GetClientFPS()));
			...
			if (m_pVideoCallSession->GetServiceType() == SERVICE_TYPE_LIVE_STREAM || m_pVideoCallSession->GetServiceType() == SERVICE_TYPE_SELF_STREAM || m_pVideoCallSession->GetServiceType() == SERVICE_TYPE_CHANNEL)
			{
				...
				if (m_nOrientationType == ORIENTATION_90_MIRRORED)
				{
					//CLogPrinter_WriteLog(CLogPrinter::INFO, INSTENT_TEST_LOG_2, "CVideoEncodingThreadOfLive::EncodingThreadProcedure 1");
				...
				{
					//CLogPrinter_WriteLog(CLogPrinter::INFO, INSTENT_TEST_LOG_2, "CVideoEncodingThreadOfLive::EncodingThreadProcedure 2");
