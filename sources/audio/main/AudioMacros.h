...
#define AAC_FRAME_TIME_DURATION 23.22
...
#define AUDIO_FLOW_OPUS_CALL 2
#define AUDIO_FLOW_AAC_LIVE_CHANNEL 3
#define AUDIO_FLOW_OPUS_LIVE_CHANNEL 4
#define AUDIO_FLOW_USELESS_CALL 5
#define AUDIO_FLOW_USELESS_STREAM 6
