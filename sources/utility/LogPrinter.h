...
#define CALL_PACKET_SIZE_LOG	OFF
#define CALL_DIMENSION_LOG		OFF
#define CHANNEL_ENHANCE_LOG		OFF
#define ENCODER_DIMENSION_LOG	OFF
#define LIVE_QUALITY_LOG		OFF
#define HEADER_TEST_LOG			OFF
#define LIVE_TYPE_LOG			OFF
#define VIDEO_FIRE_LOG			OFF
#define DECODING_FAIL_LOG		OFF
#define ENCODING_FAIL_LOG		OFF
#define BITRATE_INFO_LOG		OFF
#define BROKEN_FRAME_LOG		OFF
#define BROKEN_CHUNK_LOG		OFF
#define CHUNK_RECIVE_LOG		OFF
#define CHUNK_SENDING_LOG		OFF
#define PUBLISHER_TIME_LOG		OFF
#define CRASH_CHECK_LOG			OFF
#define WRONG_ENTRY_LOG			OFF
#define GOT_FRAME_TYPE_LOG		OFF
#define API_FLOW_CHECK_LOG		OFF
#define API_FLOW_DATA_LOG		OFF
#define VIDEO_CALL_NEG_LOG		OFF
#define PACKET_DETAILS_LOG		OFF
#define INSTENT_TEST_LOG_2		OFF
#define INSTENT_TEST_LOG_3		OFF
#define INSTENT_TEST_LOG		OFF
#define CHECK_RESULT_LOG		OFF
