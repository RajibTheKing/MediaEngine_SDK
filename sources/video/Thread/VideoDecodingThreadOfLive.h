...
#ifndef IPV_VIDEO_DECODING_THREAD_OF_LIVE_H
#define IPV_VIDEO_DECODING_THREAD_OF_LIVE_H
...
namespace MediaSDK
{
	...
	class CVideoDecodingThreadOfLive
	{

	public:

		CVideoDecodingThreadOfLive(CEncodedFrameDepacketizer *encodedFrameDepacketizer,
